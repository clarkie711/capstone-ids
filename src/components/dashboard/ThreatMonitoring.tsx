...
export const ThreatMonitoring = ({ threats, onFalsePositive }: ThreatMonitoringProps) => {
  return (
    <div className="h-full">
      <div className="sticky top-0 z-20 bg-gradient-to-r from-gray-900/90 to-gray-800/90 backdrop-blur-sm p-4 rounded-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <Tooltip>
                ...
                <TooltipContent 
                  side="top"
                  className="z-[100] max-w-[300px] space-y-2 p-4 bg-gray-900/95 border border-gray-700/50 backdrop-blur-sm shadow-xl"
                >
