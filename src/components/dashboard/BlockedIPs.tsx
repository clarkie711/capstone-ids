  ...
  if (isLoading) {
    return (
      <div className="h-full">
        <div className="sticky top-0 z-20 bg-gradient-to-r from-red-950/90 to-red-900/90 backdrop-blur-sm p-4 rounded-lg">
        ...
        <div className="text-sm text-muted-foreground px-4 mt-4">Loading...</div>
      </div>
    );
  }
            ...
            <div className="relative">
              <Tooltip>
                <TooltipTrigger asChild>
                  <button className="inline-flex items-center justify-center relative z-50">
                    <HelpCircle className="h-4 w-4 text-red-400 hover:text-red-300 transition-colors cursor-help" />
                  </button>
                </TooltipTrigger>
                <TooltipContent 
                  side="top"
                  className="z-[100] max-w-[300px] space-y-2 p-4 bg-red-950/95 border border-red-900/50 backdrop-blur-sm shadow-xl"
                >
